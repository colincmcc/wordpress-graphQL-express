...
const WooAddressTC = composeWithJson('Address', restApiResponse);

export const CoinbaseChargeGraphQLType = WooAddressTC.getType();
...
export function getWooAddressResolvers() {
  return {

  };
}

export function getWooAddressMutations() {
  return {
  };
}

export function getWooAddressSubscriptions() {
  return {

  };
}

export default WooAddressTC;
