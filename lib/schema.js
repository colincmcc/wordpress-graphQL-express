...
import {
  ...
  getCoinbaseEventHookSubscriptions,
  CoinbaseEventHookTC
} from './types/Coinbase';

import { getWooProductQueries, getWooCouponQueries } from './types/WooCommerce';
...
// * WOOCOMMERCE
// Queries
const wcProductResolvers = getWooProductQueries();
const wcCouponResolvers = getWooCouponQueries();
// Mutations
